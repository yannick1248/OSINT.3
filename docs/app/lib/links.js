...
const LINK_TREE = {
  ...
  [TargetType.PERSON]: [
    ...
    },
    {
      ...
      links: [
        ...
        { label: "OpenSanctions", description: "Recherche unifiée sanctions/PEP.", tag: "sanctions",
          url: (v) => `https://www.opensanctions.org/search/?q=${enc(v)}` },
      ],
    },
    {
      title: "Suisse — registres cantonaux",
      links: [
        { label: "Zefix (entreprises CH)", description: "Registre fédéral du commerce.", tag: "ch",
          url: (v) => `https://www.zefix.ch/fr/search/entity/list?name=${enc(v)}` },
        { label: "MoneyHouse", description: "Personnes liées à des sociétés CH.", tag: "ch",
          url: (v) => `https://www.moneyhouse.ch/fr/recherche?q=${enc(v)}` },
        { label: "Local.ch (annuaire)", description: "Annuaire suisse particuliers/pros.", tag: "ch",
          url: (v) => `https://tel.local.ch/fr/q/${enc(v)}` },
        { label: "Search.ch", description: "Annuaire complémentaire.", tag: "ch",
          url: (v) => `https://tel.search.ch/?was=${enc(v)}` },
        { label: "ZAS-AVS — n° inactivés", description: "Centrale compensation : listes A et B publiques.", tag: "ch",
  ...
  [TargetType.FREE_TEXT]: [
    ...
    {
      title: "Suisse — accès public",
      links: [
        { label: "GE — répertoire détenteurs plaques", description: "Service cantonal officiel (accès restreint).", tag: "ch",
          url: () => `https://www.ge.ch/repertoire-detenteurs-plaques-index-auto` },
        { label: "Wayback — ge.ch plaques", description: "Historique complet de la page (2008→).", tag: "archive",
          url: () => `https://web.archive.org/web/*/https://www.ge.ch/repertoire-detenteurs-plaques-index-auto` },
        { label: "ZAS-AVS — n° inactivés", description: "Listes A & B (CSV/TXT publiques).", tag: "ch",
          url: () => `https://www.zas.admin.ch/fr/numeros-inactives-ou-annules` },
        { label: "Zefix recherche", description: "Registre du commerce suisse.", tag: "ch",
          url: (v) => `https://www.zefix.ch/fr/search/entity/list?name=${enc(v)}` },
        { label: "OpenData.swiss", description: "Plateforme fédérale de données ouvertes.", tag: "ch",
          url: (v) => `https://opendata.swiss/fr/dataset?q=${enc(v)}` },
        { label: "Le Temps — archive 939", description: "Article fondateur 2008 sur le service SMS GE.", tag: "ref",
          url: () => `https://www.letemps.ch/suisse/sms-derangeants-service-automobiles` },
      ],
    },
  ],
};
